...
namespace AIE01_FirstSteps
{
    public class MessagesAndDebugging : MonoBehaviour
    {
        ...
        private void Start()
        {
            Debug.Log("I am the second function that gets called on an object with it spawns/loads. I only run once.");
        }
        ...
        {
            Debug.Log("I only run a fixed number of times per second. By default 60. I am mainly used for Physics.");
        }
        ...
        {
            Debug.Log("I run when an object is disabled/destroyed. I run every time this happens.");
        }
